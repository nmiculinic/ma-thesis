...
Code generating the function plot is displayed in figure~\ref{fg:act-code}, and the plot is in figure~\ref{fg:act_plot}
...
\section{RNN}
RNN, residual neural networks are one of the basic building blocks in sequence models. RNN's to usual feed-forward neural network 
